...
.no_message:
                    moveq    #0,d0
                    rts
                    dc.b     0,'$VER: version 1.150 (22.01.2026)',0
                    even
workbench_message:
                    dc.l     0
started_from_CLI:
...
lbC01EA70:
                    ...
                    addq.w   #7,d6
                    moveq    #0,d1
                    move.w   (lbW02549C,pc),d1
                    divu.w   #5,d1
                    lea      (lbB01B146),a0
                    move.w   (lbW02549C,pc),d2
                    adda.w   d2,a0
                    moveq    #0,d5
                    move.b   (a0),d5
                    move.w   d5,d2
...
lbC01F192:
                    ...
                    bra.b    lbC01F1D8
lbC01F19A:
                    move.w   (f6_key_line_jump_value),(lbW02549E)
                    bra.b    lbC01F1D4
lbC01F1A6:
                    move.w   (f7_key_line_jump_value),(lbW02549E)
                    bra.b    lbC01F1D4
lbC01F1B2:
                    move.w   (f8_key_line_jump_value),(lbW02549E)
                    bra.b    lbC01F1D4
lbC01F1BE:
                    move.w   (f9_key_line_jump_value),(lbW02549E)
                    bra.b    lbC01F1D4
lbC01F1CA:
                    move.w   (f10_key_line_jump_value),(lbW02549E)
lbC01F1D4:
                    bsr      lbC01F200
lbC01F1D8:
                    bsr      lbC0200FA
                    move.w   d0,d1
                    move.w   (lbW02549E,pc),d0
lbC01F1E2:
                    tst.w    d0
                    bpl.b    lbC01F1EA
                    add.w    d1,d0
...
lbC01F5E4:
                    ...
                    bra.b    lbC01F62A
lbC01F622:
                    move.w   (lbW02549C,pc),d4
                    move.w   (lbW02549E,pc),d5
lbC01F62A:
                    ext.l    d4
                    divu.w   #5,d4
                    add.w    d4,d4
...
lbC020096:
                    move.w   (lbW01B290),d1
                    add.w    (lbW0200F8,pc),d1
                    sub.w    (lbW0200F6,pc),d1
                    subq.w   #1,d1
                    cmp.w    d1,d0
                    blt.b    lbC0200B2
                    sub.w    d0,d1
...
lbC020434:
                    ...
                    bsr.b    lbC020460
                    movem.l  (sp)+,d0/d1
                    movem.w  d0/d1,(lbW020488)
                    jmp      (invert_one_char)
lbC020460:
                    tst.l    (lbW020488)
                    bmi.b    lbC020486
                    movem.l  d0/d1,-(sp)
                    movem.w  (lbW020488),d0/d1
                    jsr      (invert_one_char)
                    moveq    #-1,d0
                    move.l   d0,(lbW020488)
                    movem.l  (sp)+,d0/d1
...
clear_1_line_blitter:
                    ...
                    move.l   #$1000000,(BLTCON0,a6)
                    move.w   #0,(BLTDMOD,a6)
                    move.l   #main_screen+4480,(BLTDPTH,a6)
